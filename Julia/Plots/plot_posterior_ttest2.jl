...
xs3=marginleft:0.0001:0
xs2=-0.01:0.001:0.01

f=x -> pdf(TDist(dofr[1]), (x-mur[1])/sigmar[1])

df1 = DataFrame(DeltaAcc=xs1,pdf=f(xs1),ymin=xs1*0,ymax=f2(xs2),legend="pdf")
df3 = DataFrame(DeltaAcc=xs3,pdf=0,ymin=xs3*0,ymax=f(xs3),legend="pdf")
